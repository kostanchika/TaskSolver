...
namespace TaskSolver.Infrastructure.Persistense.Migrations
{
    ...
    [Migration("20260409224732_ConstructorChatMessageRunIo")]
    partial class ConstructorChatMessageRunIo
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TaskSolver.Core.Domain.Constructor.TaskChat", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("TaskSolver.Core.Domain.Constructor.TaskChat", b =>
                {
                    ...
                    b.OwnsMany("TaskSolver.Core.Domain.Constructor.ChatMessage", "Messages", b1 =>
                        {
                            b1.Property<Guid>("TaskChatId")
                                .HasColumnType("uuid");
