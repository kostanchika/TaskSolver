...
export const TaskPage = () => {
  ...
  useEffect(() => {
    const fetchTask = async () => {
      try {
        ...
        const response = await programmingTasksApi.getById(taskId);
  ...
  const getDifficultyColor = (degree: number) => {
    ...
    return colors[degree] || 'text-gray-400';
  };
  ...
  const getDifficultyBgColor = (degree: number) => {
    ...
    return colors[degree] || 'bg-gray-500/20 border-gray-500/50';
  };
            ...
            <div className='bg-[#2a2a2a] rounded-xl p-6 border border-[#333333] shadow-lg'>
              ...
              <div className='grid grid-cols-2 gap-4 text-sm'>
                ...
                <div className='font-mono'>
                  ...
                  <span
                    className={`ml-2 font-medium ${getDifficultyColor(task.degree)}`}
                  >
